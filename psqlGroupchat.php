...
setting (user 'root' with no password) */
    $link = pg_connect("host=localhost dbname=postgres user=postgres port=5432 password=1234");
...
<body onload="show_func()">
    <div id="container">
        <main>
            ...
            <form id="myform" action="psqlGroupchat.php" method="POST">
                <div class="inner_div" id="chathist">
                    ...
                    $db_name = "postgres";
                    $port = "5432";
                    $con =pg_connect("host=localhost dbname=postgres user=postgres port=5432 password=1234");

                    $query = "SELECT * FROM finalchat";
                    $run = pg_query($con,$query);
                    $i = 0;
